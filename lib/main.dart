  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        //main profile screen
        // "/main_student_profile": (context) =>  MainStudentProfile(),
        //Home Student Screen
        "/home_student_screen": (context) => HomeStudentScreen(),
        //my treatment screen
        "/my_treatment_screen": (context) => ActiveCases(),
        //students screen
        "/students_screen": (context) => Students(),
        //EditProfile screen
